...
public class BeltsAdapter extends RecyclerView.Adapter<BeltsAdapter.CategorizedProductHolder> {
    List<Product> products;

    public BeltsAdapter(List<Product> products, Belts belts){
        this.products = products;
    }
    @Override
    public CategorizedProductHolder onCreateViewHolder( ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.card_layout, parent , false);
        return  new BeltsAdapter.CategorizedProductHolder(view);
    }
    @Override
