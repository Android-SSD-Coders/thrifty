...
import com.example.thrifty.KidsClothes;
...
public class KidsClothesAdapter extends RecyclerView.Adapter<KidsClothesAdapter.CategorizedProductHolder> {
    List<Product> products;

    public KidsClothesAdapter(List<Product> products, KidsClothes kidsClothes){
        this.products = products;
    }
    @Override
    public CategorizedProductHolder onCreateViewHolder( ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.card_layout, parent , false);
        return  new KidsClothesAdapter.CategorizedProductHolder(view);
    }
    @Override
